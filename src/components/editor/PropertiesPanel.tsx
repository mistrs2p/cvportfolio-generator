...
const fontWeights: SlideNode["style"]["fontWeight"][] = [
  "normal",
  "medium",
  "semibold",
  "bold",
...
export default function PropertiesPanel() {
  const { nodes, selectedId, updateNode } = useEditorStore();
  ...
  return (
    <aside className="w-56 bg-slate-900 border-l border-slate-800 overflow-y-auto shrink-0">
      <div className="p-4 space-y-5">
        ...
        {node.type !== "image" && (
          <div>
            <label className="block text-slate-400 text-xs mb-1.5">Style</label>
            <button
              onClick={() =>
